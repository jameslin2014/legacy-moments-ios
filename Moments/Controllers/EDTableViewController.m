...
//  Moments
//
//  Created by Evan Dekhayser on 1/17/15.
...
@interface EDTableViewController () <PBJVideoPlayerControllerDelegate, UITableViewDataSource, UITableViewDelegate>
...
- (NSInteger)numberOfSectionsInTableView:(UITableView *)tableView {
	...
	return tableView == self.identityTableView ? 1 : self.recents.count ? 1 : 0;
}

- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
	// Return the number of rows in the section.
	return tableView == self.identityTableView ? 1 : self.recents.count;
}
